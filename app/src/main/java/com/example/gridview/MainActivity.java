...
/*quan tam chieu ngang numColum so cot
 khoang trang dãng dòng của cột verticalSpacing
độ rông các cột columnWidth;*/
...
public class MainActivity extends AppCompatActivity {
    String arr[]={"Ipad","Iphone","New Ipad","Samsung","Nokia","Sony","Lg","Q-Mobile","HTC"};
